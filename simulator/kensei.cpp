...
// kensei.cpp by Kosei Demura (2007-6-19)
...
static void nearCallback(void *data, dGeomID o1, dGeomID o2) {
    ...
    if ((b1 == rlink[LEFT_UPPER_ARM_DUMMY1].id) || (b1 == rlink[LEFT_UPPER_ARM_DUMMY2].id) ||
        (b1 == rlink[LEFT_UPPER_ARM_DUMMY1].id) || (b1 == rlink[LEFT_UPPER_ARM_DUMMY2].id) ||
        (b1 == rlink[LEFT_THIGH_DUMMY1].id) || (b1 == rlink[LEFT_THIGH_DUMMY2].id) ||
        (b1 == rlink[LEFT_THIGH_DUMMY1].id) || (b1 == rlink[LEFT_THIGH_DUMMY2].id) ||
        (b1 == rlink[LEFT_FOOT_DUMMY].id) || (b1 == rlink[LEFT_FOOT_DUMMY].id))
        return;
    if ((b2 == rlink[RIGHT_UPPER_ARM_DUMMY1].id) || (b2 == rlink[RIGHT_UPPER_ARM_DUMMY2].id) ||
        (b2 == rlink[RIGHT_UPPER_ARM_DUMMY1].id) || (b2 == rlink[RIGHT_UPPER_ARM_DUMMY2].id) ||
        (b2 == rlink[RIGHT_THIGH_DUMMY1].id) || (b2 == rlink[RIGHT_THIGH_DUMMY2].id) ||
        (b2 == rlink[RIGHT_THIGH_DUMMY1].id) || (b2 == rlink[RIGHT_THIGH_DUMMY2].id) ||
        (b2 == rlink[RIGHT_FOOT_DUMMY].id) || (b2 == rlink[RIGHT_FOOT_DUMMY].id))
        return;
    if (((b1 == rlink[LEFT_UPPER_ARM].id) && (b2 == rlink[TORSO].id)) ||
        ((b2 == rlink[LEFT_UPPER_ARM].id) && (b1 == rlink[TORSO].id)))
        return;
    if (((b1 == rlink[RIGHT_UPPER_ARM].id) && (b2 == rlink[TORSO].id)) ||
        ((b2 == rlink[RIGHT_UPPER_ARM].id) && (b1 == rlink[TORSO].id)))
        return;
    if (((b1 == rlink[LEFT_THIGH].id) && (b2 == rlink[TORSO].id)) ||
        ((b2 == rlink[LEFT_THIGH].id) && (b1 == rlink[TORSO].id)))
        return;
    if (((b1 == rlink[RIGHT_THIGH].id) && (b2 == rlink[TORSO].id)) ||
        ((b2 == rlink[RIGHT_THIGH].id) && (b1 == rlink[TORSO].id)))
        return;
    if (((b1 == rlink[LEFT_CALF].id) && (b2 == rlink[LEFT_FOOT].id)) ||
        ((b2 == rlink[LEFT_CALF].id) && (b1 == rlink[LEFT_CALF].id)))
        return;
    if (((b1 == rlink[RIGHT_CALF].id) && (b2 == rlink[RIGHT_FOOT].id)) ||
        ((b2 == rlink[RIGHT_CALF].id) && (b1 == rlink[RIGHT_FOOT].id)))
        return;
    ...
    if (int numc = dCollide(o1, o2, contact_no, &contact[0].geom, sizeof(dContact))) {
...
void start() {
    static float xyz[3] = {2.2f, -1.3f, 1.8f};
    static float hpr[3] = {125.5f, -17.0f, 0.0f};
...
static void readLinkParam() {
    ...
    rlink[RIGHT_UPPER_ARM_DUMMY1].py = -rlink[LEFT_UPPER_ARM_DUMMY1].py;
    ...
    rlink[RIGHT_UPPER_ARM_DUMMY2].py = -rlink[LEFT_UPPER_ARM_DUMMY2].py;
    ...
    rlink[RIGHT_UPPER_ARM].py = -rlink[LEFT_UPPER_ARM].py;
    ...
    rlink[RIGHT_FORE_ARM].py = -rlink[LEFT_FORE_ARM].py;
    ...
    rlink[RIGHT_HAND].py = -rlink[LEFT_HAND].py;
    ...
    rlink[RIGHT_THIGH_DUMMY1].py = -rlink[LEFT_THIGH_DUMMY1].py;
    ...
    rlink[RIGHT_THIGH_DUMMY2].py = -rlink[LEFT_THIGH_DUMMY2].py;
    ...
    rlink[RIGHT_THIGH].py = -rlink[LEFT_THIGH].py;
    ...
    rlink[RIGHT_CALF].py = -rlink[LEFT_CALF].py;
    ...
    rlink[RIGHT_FOOT_DUMMY].py = -rlink[LEFT_FOOT_DUMMY].py;
    ...
    rlink[RIGHT_FOOT].py = -rlink[LEFT_FOOT].py;
...
void readJointParam() {
    ...
    rjoint[RIGHT_SHOULDER_YAW].py = -rjoint[LEFT_SHOULDER_YAW].py;
    ...
    rjoint[RIGHT_SHOULDER_ROLL].py = -rjoint[LEFT_SHOULDER_ROLL].py;
    ...
    rjoint[RIGHT_SHOULDER_PITCH].py = -rjoint[LEFT_SHOULDER_PITCH].py;
    ...
    rjoint[RIGHT_HIP_YAW].py = -rjoint[LEFT_HIP_YAW].py;
    ...
    rjoint[RIGHT_HIP_ROLL].py = -rjoint[LEFT_HIP_ROLL].py;
    ...
    rjoint[RIGHT_HIP_PITCH].py = -rjoint[LEFT_HIP_PITCH].py;
    ...
    rjoint[RIGHT_ELBOW_PITCH].py = -rjoint[LEFT_ELBOW_PITCH].py;
    ...
    rjoint[RIGHT_KNEE_PITCH].py = -rjoint[LEFT_KNEE_PITCH].py;
    ...
    rjoint[LEFT_FOOT_ROLL].lo_stop = -90.0 * (M_PI / 180.0);
    ...
    rjoint[RIGHT_FOOT_PITCH].py = -rjoint[LEFT_FOOT_PITCH].py;
    ...
    rjoint[RIGHT_FOOT_ROLL].py = -rjoint[LEFT_FOOT_ROLL].py;
...
void startSimulation() {
    std::lock_guard<std::mutex> lock(mutex);
    if (started) {
        std::cout << "Simulator is already started" << std::endl;
        return;
    }
...
void setValue(dReal *target, float value) {
    if (value != -1) {
        *target += value;
    }
}

void setAngle(const simulator::Angle &angle) {
    switch (angle.kind()) {
        case simulator::RIGHT_SHOULDER:
            setValue(&right_shoulder_roll, angle.roll());
            setValue(&right_shoulder_pitch, angle.pitch());
            setValue(&right_shoulder_yaw, angle.yaw());
            break;
        case simulator::RIGHT_ELBOW:
            setValue(&right_elbow_pitch, angle.pitch());
            break;
        case simulator::RIGHT_HIP:
            setValue(&right_hip_roll, angle.roll());
            setValue(&right_hip_pitch, angle.pitch());
            setValue(&right_hip_yaw, angle.yaw());
            break;
        case simulator::RIGHT_KNEE:
            setValue(&right_knee_pitch, angle.pitch());
            break;
        case simulator::RIGHT_FOOT:
            setValue(&right_foot_roll, angle.roll());
            setValue(&right_foot_pitch, angle.pitch());
            break;
        case simulator::LEFT_SHOULDER:
            setValue(&left_shoulder_roll, angle.roll());
            setValue(&left_shoulder_pitch, angle.pitch());
            setValue(&left_shoulder_yaw, angle.yaw());
            break;
        case simulator::LEFT_ELBOW:
            setValue(&left_elbow_pitch, angle.pitch());
            break;
        case simulator::LEFT_HIP:
            setValue(&left_hip_roll, angle.roll());
            setValue(&left_hip_pitch, angle.pitch());
            setValue(&left_hip_yaw, angle.yaw());
            break;
        case simulator::LEFT_KNEE:
            setValue(&left_knee_pitch, angle.pitch());
            break;
        case simulator::LEFT_FOOT:
            setValue(&left_foot_roll, angle.roll());
            setValue(&left_foot_pitch, angle.pitch());
            break;
    }
}

void step(const simulator::Angle &angle) {
    if (!started) {
        return;
    }
    setAngle(angle);
...
void end() {
    std::lock_guard<std::mutex> lock(mutex);
    if (!started) {
        std::cout << "Simulator not started." << std::endl;
        return;
    }
    started = false;
...
simulator::Position getPosition(simulator::PartsKind kind) {
    simulator::Position position{};
    position.set_kind(kind);

    switch (kind) {
        case simulator::HEAD:
            auto p = dBodyGetPosition(rlink[HEAD].id);
            position.set_x(p[0]);
            position.set_y(p[1]);
            position.set_z(p[2]);
    }
